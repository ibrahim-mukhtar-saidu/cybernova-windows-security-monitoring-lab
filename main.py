...
SAMPLE_LOG = BASE_DIR / "samples" / "windows_security_events.log"
REPORT_DIR = BASE_DIR / "reports" / "generated"

JSON_REPORT = REPORT_DIR / "windows_security_alerts.json"
HTML_REPORT = REPORT_DIR / "windows_security_report.html"
...
def main():
    ...
    generate_json_report(alerts, JSON_REPORT)
    generate_html_report(alerts, HTML_REPORT)
